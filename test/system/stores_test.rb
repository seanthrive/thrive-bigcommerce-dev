...
class StoresTest < ApplicationSystemTestCase
  ...
  test "creating a Store" do
    ...
    fill_in "Access token", with: @store.access_token
    fill_in "Email", with: @store.email
    fill_in "Scope", with: @store.scope
    fill_in "Store hash", with: @store.store_hash
    fill_in "Username", with: @store.username
